...
//    canvas.drawCircle(
//        offsetInCanvas.translate(0.0, 4.0),
//        10.0,
//        Paint()
...
class LineTouchTooltipData with EquatableMixin {
  ...
  LineTouchTooltipData({
    ...
    DateTime firstDate,
        ...
        newStyleTooltip = newStyleTooltip ?? false,
...
List<LineTooltipItem> defaultLineTooltipItem(List<LineBarSpot> touchedSpots) {
  ...
  return touchedSpots.map((LineBarSpot touchedSpot) {
    ...
    return LineTooltipItem(touchedSpot.y.toString(), touchedSpot.x.toString(), textStyle);
  }).toList();
}
...
class LineTooltipItem with EquatableMixin {
  ...
  /// Showing vertical text.
  final String textVertical;

  /// Style of showing text.
  final TextStyle textStyle;

  /// Shows a [text] with [textStyle] as a row in the tooltip popup.
  LineTooltipItem(this.text, this.textVertical, this.textStyle);
